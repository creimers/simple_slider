...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Slider.autoplay'
        db.add_column('djangocms_simple_slider_slider', 'autoplay',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Slider.autoplay'
        db.delete_column('djangocms_simple_slider_slider', 'autoplay')
    ...
    models = {
        ...
        'djangocms_simple_slider.image': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['filer.Image']"}),
